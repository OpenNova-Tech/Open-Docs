...
export const SEARCH_ITEMS: SearchItem[] = [
  ...
  { title: 'Git Over Other VCS', ref: '/docs/tools/git/5', icon: '/icons/tools/git.svg' },
  { title: 'Git Create Repositories', ref: '/docs/tools/git/6', icon: '/icons/tools/git.svg' },
  { title: 'Git Staging', ref: '/docs/tools/git/7', icon: '/icons/tools/git.svg' },
  { title: 'Git Commits', ref: '/docs/tools/git/8', icon: '/icons/tools/git.svg' },
  { title: 'Git View History', ref: '/docs/tools/git/9', icon: '/icons/tools/git.svg' },
  { title: 'Git Ignore Files', ref: '/docs/tools/git/10', icon: '/icons/tools/git.svg' },
]
