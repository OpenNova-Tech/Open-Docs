import { Code, GitFork, Users, Lightbulb, CheckCircle, AlertCircle, Github } from 'lucide-react'
    ...
    <div className='min-h-screen bg-black'>
      <div className='max-w-5xl mx-auto px-6 py-36'>
        <div className='text-center mb-16'>
          <div className='inline-flex items-center justify-center w-20 h-20 bg-indigo-950 rounded-full mb-6'>
            <Github className='w-10 h-10 text-indigo-200' />
          </div>
          <h1 className='text-5xl font-bold text-indigo-200 mb-4'>
            Contributing Guide
          </h1>
        ...
        <div className='bg-neutral-900 rounded-2xl shadow-lg p-8 mb-12'>
          <h2 className='text-3xl font-bold text-indigo-200 mb-6 flex items-center gap-3'>
            <GitFork className='w-8 h-8 text-indigo-200' />
            How to Contribute
          </h2>
            ...
            <div className='flex gap-6'>
              ...
              <div className='flex-1'>
                ...
                <div className='bg-neutral-800 rounded-lg p-4 font-mono text-sm text-gray-200 mb-3'>
                  ...
                  <div className='text-indigo-200'>git clone https://github.com/OpenNova-Tech/Open-Docs.git</div>
                  <div className='text-indigo-200 mt-1'>cd Open-Docs</div>
                </div>
            ...
            <div className='flex gap-6'>
              ...
              <div className='flex-1'>
                ...
                <div className='bg-neutral-800 rounded-lg p-4 font-mono text-sm text-gray-800 mb-3'>
                  <div className='text-indigo-200'>git checkout -b feature/new-feature</div>
                </div>
        ...
        <div className='bg-neutral-900 rounded-2xl shadow-lg p-8 mb-12'>
          <h2 className='text-3xl font-bold text-indigo-200 mb-6'>Ways to Contribute</h2>
          <div className='grid md:grid-cols-3 gap-6'>
            <div className='bg-gradient-to-br from-indigo-950 to-indigo-900 rounded-xl p-6'>
              <Code className='w-8 h-8 text-indigo-200 mb-4' />
            ...
            <div className='bg-gradient-to-br from-indigo-950 to-indigo-900 rounded-xl p-6'>
              <AlertCircle className='w-8 h-8 text-indigo-200 mb-4' />
            ...
            <div className='bg-gradient-to-br from-indigo-950 to-indigo-900 rounded-xl p-6'>
              <Lightbulb className='w-8 h-8 text-indigo-200 mb-4' />
        ...
        <div className='bg-gradient-to-r from-indigo-950 to-indigo-900 rounded-2xl shadow-lg p-8 text-white'>
        ...
        <div className='text-center mt-16'>
          ...
          <div className='flex justify-center gap-4'>
            <button className='bg-indigo-900 hover:bg-indigo-950 cursor-pointer text-white font-semibold px-8 py-3 rounded-lg transition-colors'>
              View Open Issues
            </button>
            <button className='bg-indigo-900 hover:bg-indigo-950 cursor-pointer text-white font-semibold px-8 py-3 rounded-lg transition-colors'>
              Join Discussions
