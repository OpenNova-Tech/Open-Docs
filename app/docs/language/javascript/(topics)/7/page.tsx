...
const assignment = [
  ...
  {
    operator: '*=',
    description: 'Multiply and Assign',
    example: 'x *= 2',
    result: 'x = x * 2',
  },
  {
    operator: '/=',
    description: 'Divide and Assign',
    example: 'x /= 2',
    result: 'x = x / 2',
  },
]
...
const comparision = [
  {
    operator: '==',
    description: 'Equal (lose)',
    example: "5 == '5'",
    result: 'true',
  },
  {
    operator: '===',
    description: 'Equal (strict)',
    example: "5 === '5'",
    result: 'false',
  },
  {
    operator: '!=',
    description: 'Not Equal (loose)',
    example: "5 != '5'",
    result: 'false',
  },
  {
    operator: '!==',
    description: 'Not Equal (strict)',
    example: "5 !== '5'",
    result: 'true',
  },
  {
      ...
      <div className='max-w-4xl mx-auto space-y-12'>
        ...
        >
          <h2 className='text-2xl font-bold mb-4 text-gray-100'>
            <b className='text-[#F1E05A]'>7.1</b> Operators and Expressions in
            JavaScript
          </h2>
          <div className='max-w-3xl mx-auto text-gray-300'>
            ...
            <br />
            <br />
            Comparision Operators - Used to compare values then return true or
            false <br />
            <br />
            <Table>
              <TableHeader>
            ...
            <CodeBlock language='js' filename='logical.js' code={code15} />{' '}
            <br />
            <br />
          </div>
        </motion.div>
