      ...
      <div className='max-w-4xl mx-auto space-y-12'>
        ...
        >
          ...
          <div className='max-w-3xl mx-auto text-gray-300'>
            <b>•</b> Created by Brendan Eich in just 10 days while working at
            Netscape. <br />
            <b>•</b> Originally called Mocha, later renamed LiveScript, and
            finally JavaScript. <br />
            <b>•</b> Purpose: make websites interactive (e.g., form validation,
            simple animations).
          </div>
        </motion.div>
        ...
        >
          ...
          <div className='max-w-3xl mx-auto text-gray-300'>
            ...
            <b>•</b> Microsoft created a competitor called JScript in Internet
            Explorer. <br />
            <b>•</b> Resulted in browser wars (1990s) → inconsistent behavior
            across browsers.
          </div>
        </motion.div>
        ...
        >
          ...
          <div className='max-w-3xl mx-auto text-gray-300'>
            <b>•</b> To avoid chaos, JavaScript was standardized by ECMA
            International as ECMAScript (ES). <br />
        ...
        >
          ...
          <div className='max-w-3xl mx-auto text-gray-300'>
            <b>•</b> ES3 (1999): Regular expressions, try/catch, better string
            handling. <br />
            <b>•</b> ES5 (2009): JSON support, strict mode, array methods like{' '}
            <span className='bg-neutral-800 px-2 rounded-lg'>forEach</span>,{' '}
            <span className='bg-neutral-800 px-2 rounded-lg'>map</span>. <br />
            <b>•</b> ES6 / ES2015: Biggest update! Introduced{' '}
            <span className='bg-neutral-800 px-2 rounded-lg'>let</span>,{' '}
            <span className='bg-neutral-800 px-2 rounded-lg'>const</span>, arrow
            functions, classes, promises, modules. <br />
            <b>•</b> Later versions (ES2016+): Async/await, optional chaining,
            modules, modern features every year.
          </div>
        </motion.div>
        ...
        >
          ...
          <div className='max-w-3xl mx-auto text-gray-300'>
            <b>•</b> Runs not only in browsers but also on servers (via
            Node.js). <br />
