      ...
      <div className='max-w-4xl mx-auto space-y-12'>
        ...
        >
          ...
          <div className='max-w-3xl mx-auto text-gray-300'>
            JavaScript lets our code respond differently based on user inputs,
            values or situations <br />
            <br />
            ...
            Switch Statement - It is used when we have many exact matches to
            check <br />
            <br />
