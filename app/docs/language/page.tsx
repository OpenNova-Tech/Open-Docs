...
export default function page() {
  const development = [
    ...
    {
      title: 'Swift',
      description: 'Apples safe and fast language for iOS and macOS apps.',
    ...
    {
      title: 'C#',
      description: 'Microsofts modern object-oriented language used with the .NET framework.',
  ...
  const systems = [
    ...
    {
      title: 'Go',
      description: 'Googles compiled language known for concurrency and efficient networking tools.',
